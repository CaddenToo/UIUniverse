package arnett.uIUniverse.ui.dialog.types.multi;
...
public abstract class MultiPrompt extends Prompter {
    ...
    /**
     * @return {@code List<ActionButton>} the list of action buttons to display
     */
    public abstract List<ActionButton> actionButtons();
